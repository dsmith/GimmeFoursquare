...
- (id) initWithRequestToken:(OAToken*)token
{
    if(self = [super init]) {
        requestToken = token;
    }
...
- (void) viewDidLoad
{
    ...
    NSURL* url = [NSURL URLWithString:[NSString stringWithFormat:@"http://foursquare.com/mobile/oauth/authorize?oauth_token=%@", requestToken.key]];
